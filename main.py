...
address_book_location = "/Users/" + os.getlogin() + "/Library/Application Support/AddressBook/Sources/2793F06D-6593-484F-9328-8E1A295B9D3F/AddressBook-v22.abcddb"

# ask the user for the number of messages to read
#n = input("Enter the number of messages to read: ")
recent_messages = read_messages(chatdb_location, 100)
